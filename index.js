...
process.on('SIGHUP',  function(){ console.log('CLOSING [SIGHUP]');  process.exit()})
process.on('SIGINT',  function(){ console.log('CLOSING [SIGINT]');  process.exit()})
process.on('SIGQUIT', function(){ console.log('CLOSING [SIGQUIT]'); process.exit()})
process.on('SIGABRT', function(){ console.log('CLOSING [SIGABRT]'); process.exit()})
process.on('SIGTERM', function(){ console.log('CLOSING [SIGTERM]'); process.exit()})
